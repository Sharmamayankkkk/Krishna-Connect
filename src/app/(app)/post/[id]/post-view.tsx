...
export default function PostView() {
    ...
    const {
        ...
        updatePost,
        onDeletePost: () => router.push('/explore') // Redirect to feed on delete
    });
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            ...
            // For now, simpler to append to local state if structure matches
            if (data) {
                const newComment = {
                    ...data,
                    author: data.user, // Map user to author as expected by PostCard
                    likes: []
                };
