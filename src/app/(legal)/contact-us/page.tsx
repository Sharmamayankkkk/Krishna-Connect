      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="bg-card p-8 rounded-2xl border border-border/50 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center">
          ...
          <Button asChild className="rounded-full">
            <a href="mailto:madanmohandas@krishnaconnect.in">Send Email</a>
          </Button>
        </div>
        ...
        <div className="bg-card p-8 rounded-2xl border border-border/50 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-bold mb-2">Report Abuse or Violation</h2>
          <p className="text-muted-foreground mb-6 flex-1">
          ...
          <Button asChild variant="destructive" className="rounded-full">
            <a href="mailto:madanmohandas@krishnaconnect.in?subject=Abuse%20Report">
              Report Now
            </a>
          </Button>
        </div>
        ...
        <div className="bg-card p-8 rounded-2xl border border-border/50 shadow-sm hover:shadow-md transition-all flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-bold mb-2">Legal Inquiries</h2>
          <p className="text-muted-foreground mb-6 flex-1">
            For DMCA takedown notices, law enforcement requests, data privacy
            inquiries, or other legal matters.
          </p>
          <Button asChild variant="outline" className="rounded-full">
            <a href="mailto:madanmohandas@krishnaconnect.in?subject=Legal%20Inquiry">
              Contact Legal
            </a>
          </Button>
        </div>
